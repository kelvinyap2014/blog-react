...
export const EntitiesMenu = props => (
  ...
  <NavDropdown icon="th-list" name={translate('global.menu.entities.main')} id="entity-menu">
    <DropdownItem tag={Link} to="/entity/blog">
      <FontAwesomeIcon icon="asterisk" />&nbsp;<Translate contentKey="global.menu.entities.blog" />
    </DropdownItem>
    <DropdownItem tag={Link} to="/entity/entry">
      <FontAwesomeIcon icon="asterisk" />&nbsp;<Translate contentKey="global.menu.entities.entry" />
    </DropdownItem>
